...
footer_text <- paste("Lecture 13: Estimating Regression Discontinuity -",
                     "Course Title:  -",
                     Sys.Date())
...
<div class="footer">Lecture 13: Estimating Regression Discontinuity - Course Title:  - `r Sys.Date()`</div>
