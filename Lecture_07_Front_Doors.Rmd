...
<h1>Lecture 7: Front Doors, and Other Details</h1>
...
```{r, dev = 'CairoPNG', fig.height = 9, fig.width=12}
...
dag <- dagify(Outcome ~ Treatment + AnnoyingEndogeneity,
              ...
              coords = list(
                x = c(Randomization = 0, Treatment = 2, AnnoyingEndogeneity = 4, Outcome = 6),
...
```{r, dev='CairoPNG', echo=FALSE, fig.width=10, fig.height=5}
...
```{r, dev='CairoPNG', echo=FALSE, fig.width=9, fig.height=5}
dag <- dagify(tar~cigs,
              cigs~health+income,
